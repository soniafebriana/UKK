...
foreach ($siswa as $pro):
  ?>
                      ...
                      <tr>
                              ...
                              <td><?=  $pro['alamat'];?></td>
                              <td>
                                <button class="btn btn-danger" data-toggle="modal" data-target="#hapus_karyawan<?=$pro['id'];?>">
                ...
                <div class="modal-content">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="no_telp" value="<?=$pro['no_telp'];?>">
                    </div>
                    <div class="form-group">
                      <label>Alamat</label>
                      <input class="form-control" type="text" name="alamat" value="<?=$pro['alamat'];?>">
                    </div>
                    <div class="form-group">
          <label>Kelas</label>
