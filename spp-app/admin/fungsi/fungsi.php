...
function edit_siswa()
{
	...
	$save1 =  mysqli_query($koneksi, "UPDATE tb_siswa SET nis='$nis', nama='$nama', kelas='$kelas', prodi='$prodi',no_telp='$no_telp', alamat='$alamat',tstamp='$tstamp', admin='$admin' WHERE id='$id'");
